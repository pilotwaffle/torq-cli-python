"""Application boundary for the bounded normalized V5 import command."""
...
def import_v5_path(config_path: str) -> ResultEnvelope:
    try:
        ...
        parse_finding, document = parse_legacy_config(raw)
        ...
        mapping_finding = validate_legacy_mapping(document, reference)
        ...
        data: Mapping[str, Any] = {
            ...
            "source_schema": "torq-oracle-v5-config-v1",
...
def reachability_case(finding_id: str) -> tuple[str]:
    """Closed synthetic reachability hook used only by the catalog regression tests."""
    return (finding_id,)
